...
public:
    ...
    uint64_t get_performance_counter() const;
    void execute_10_cycles_loop(uint32_t iterations) const;
    ...
    void enable_uart_interrupts(void (*handler)());
    void disable_uart_interrupts();

    void enable_spi_interrupts(void (*handler)());
    ...
    void (*uart_interrupts_handler)(){nullptr};
    void (*spi_interrupts_handler)(){nullptr};
};
